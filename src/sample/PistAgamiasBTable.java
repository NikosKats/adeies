...
public class PistAgamiasBTable implements Initializable {
    ...
    public void delete(int id) {
        String sql = "DELETE FROM dataAgamiasB WHERE id = ?";
    ...
    public void view(ActionEvent actionEvent) {
        PistAgamiasBTableData data = (PistAgamiasBTableData) tableView.getSelectionModel().getSelectedItem();
        ...
        else
        {
            ...
            Preferences preferences = Preferences.userNodeForPackage(PistAgamiasBTable.class);
            ...
            try {
                FXMLLoader loader = new FXMLLoader(Main.class.getResource("pistAgamiasBView.fxml"));
                AnchorPane pane = loader.load();
                Scene scene = new Scene(pane);
    ...
    public void edit(ActionEvent actionEvent) {
        ...
        if(data == null)
        {
            ...
            try {
                FXMLLoader loader = new FXMLLoader(Main.class.getResource("pistAgamiasBEdit.fxml"));
                AnchorPane pane = loader.load();
                Scene scene = new Scene(pane);
                ...
                stage.setResizable(false);
                stage.setTitle("Επεξεργασία Δήλωσης Πιστοποιητικού Αγαμίας B");
