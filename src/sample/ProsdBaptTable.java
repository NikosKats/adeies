...
public class ProsdBaptTable implements Initializable {
    ...
    ObservableList<ProsdBaptisisTableData> obList = FXCollections.observableArrayList();
    ...
    public void delete(int id) {
        String sql = "DELETE FROM dataProsdBaptisis WHERE id = ?";
    ...
    public void selectAll(){
        String sql = "SELECT * FROM dataProsdBaptisis";
        ...
        try (Connection conn = this.connect();
            ...
            while (rs.next()) {
                ...
                obList.add(new ProsdBaptisisTableData(s_id,Field2,Field3,Field4,Field6,Field7,Field8,Field11,Field12,Field23,Field31));
    ...
    public void view(ActionEvent actionEvent) {
        ProsdBaptisisTableData data = (ProsdBaptisisTableData) tableView.getSelectionModel().getSelectedItem();
        ...
        else
        {
            ...
            try {
                FXMLLoader loader = new FXMLLoader(Main.class.getResource("prosdBaptView.fxml"));
                AnchorPane pane = loader.load();
                Scene scene = new Scene(pane);
    ...
    public void edit(ActionEvent actionEvent) {
        ...
        if(data == null)
        {
            ...
            Preferences preferences = Preferences.userNodeForPackage(ProsdBaptTable.class);
            preferences.put("id",pass_id);
            ...
            try {
                FXMLLoader loader = new FXMLLoader(Main.class.getResource("prosdBaptEdit.fxml"));
                AnchorPane pane = loader.load();
                Scene scene = new Scene(pane);
